...
//! Project version number for NSLNavigationSolution.
FOUNDATION_EXPORT double NSLNavigationSolutionVersionNumber;

//! Project version string for NSLNavigationSolution.
